...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String EXTRA_ITEM = "com.nasatech.moviecatalogue.widget.EXTRA_ITEM";
    private static final String TOAST_ACTION = "com.nasatech.moviecatalogue.widget.TOAST_ACTION";
